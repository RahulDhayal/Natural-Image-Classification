...
Original file is located at
    https://colab.research.google.com/drive/1KowQfYROoUhqQvgjj1Wzz7rzkIMUhbKf
"""
...
def MLP_train(X_train,y_train,X_test,y_test):
  ...
  for train, test in kfold.split(inputs, targets):
    ...
    #fitting the network
    mlp.fit(inputs[train], targets[train], epochs=25,batch_size=64,verbose=2)
...
def CNN_train(X_train, y_train, X_test, y_test):
  ...
  for train, test in kfold.split(inputs, targets):
    ...
    #fitting the network
    history=cnn.fit(train_generator, validation_data=valid_generator,steps_per_epoch=110,epochs=2, validation_steps=100,verbose=1)
